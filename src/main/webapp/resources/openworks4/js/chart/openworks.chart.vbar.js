 ...
 *  
 *  실행
 *  opVChartBars(opChartOption);
 */
var opVChartBars = function(option) {
    ...
    d3.json(option.dataUrl, function(data) {
        ...
        svg.append("g").attr("class", "x axis").attr("transform", "translate(0," + height + ")").call(xAxis); // .append("text").attr("y", 6).attr("dy", ".71em").style("text-anchor", "end").attr("class", "barText").text(option.xBarNm);
