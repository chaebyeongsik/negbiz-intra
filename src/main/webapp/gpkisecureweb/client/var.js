...
var ClientInstallPage   = '/gpkisecureweb/install.html';    // * 설치 페이지 경로
var ServiceStartPageURL = '/intra/mngr/PD_updateMngrCrtfcAcntForm.do';      // * 설치완료후 이동할 페이지
...
var SiteID        = 'yongin.go.kr';                // * SiteID : 세션정보를 관리하는 고유 ID. 사이트 별로 고유 이름을 설정
