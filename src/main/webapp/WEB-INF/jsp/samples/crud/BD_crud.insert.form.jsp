...
<op:jsTag type="libs" items="form, validate, froala" /><!-- ckeditor -->
 ...
 */
        $('#htmlContent').froalaEditor({
            fileUploadURL: '/component/file/ND_fileFroalaUpload.do',
            imageUploadURL : '/component/file/ND_fileFroalaUpload.do',
            height: 500
        });
     ...
     */
    var opFileUpdate = function(fileSn) {
        $().colorbox({
            title : "파일정보 수정",
            href : "/component/file/PD_fileUpdateForm.do?q_fileSn=" + fileSn,
            width : "650",
            height : "450",
            iframe : true
        });
...
<body>
    ...
    <form name="dataForm" id="dataForm" method="post" enctype="multipart/form-data" action="ND_crud.insert.do" class="form-horizontal">
            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-10">
                        <div class="row">
                            <div class="col-md-12">
                                <input type="text" name="ttl" id="ttl" title="제목을 입력해주세요" value="" class="form-control" />
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-8">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-10">
                        <div class="row">
                            <div class="col-md-2">
                                <select name="clsfNo" id="clsfNo" class="select">
                                    <option value="">선택하세요.</option>
                                    <option value="1001" >분류1</option>
                                    <option value="1002" >분류2</option>
                                </select>
                            </div>
                        </div>
                        <div class="row">
                ...
                <div class="form-group">
                    <label for="ntcPstYn" class="control-label col-md-2">공지여부</label>
                    <div class="col-md-10">
                        <div class="row">
                            <div class="col-md-8">
                                <label for="ntcPstYnY" class="checkbox-inline checkbox-primary">
                                    <input type="checkbox" name="ntcPstYn" id="ntcPstYnY" value="Y" class="styled" />
                                    공지로 사용
                                </label>
                            </div>
                        </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-10">
                        <div class="row">
                            <div class="col-md-12">
                                <textarea id="htmlContent" name="docContsCn" rows="10" class="form-control froala" title="내용입력"></textarea>
<!--                                 <textarea id="htmlContent" name="docContsCn" rows="10" class="form-control ckeditor" title="내용입력"></textarea> -->
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-8">
                ...
                <div class="form-group">
                    <label for="fileInput" class="control-label col-md-2">첨부파일1</label>
                    <div class="col-md-10">
                ...
                <div class="form-group">
                    <label for="fileInput1" class="control-label col-md-2">첨부파일2(실제업로드는 없음)</label>
                    <div class="col-md-10">
                        <op:fileUpload view="basic" name="fileInput1" fileIdNm="test" count="3" size="2M" maxSize="5M" exts="jpg,jpeg,gif,png" fileList="${dataVo.fileList}" />
                    </div>
                </div>
