...
<body>
    ...
    <div class="row">
        <div class="col-sm-12 btn-group">
            <div class="pull-right">
               <button type="button" id="excelDown" class="btn btn-info" onclick="opExcelDownForm('user-hist-list-U');">엑셀출력</button>
            </div>
        </div>
    </div>
    <!-- //버튼 -->
                ...
                <div class="block">
                    <div class="form-group">
                        ...
                        <select id="q_searchKey" name="q_searchKey" class="select" style="width: 120px;">
                            ...
                            <option <c:if test="${paramMap.q_searchKey == 1004}">selected="selected"</c:if> value="1004">변경자명</option>
                            <option <c:if test="${paramMap.q_searchKey == 1005}">selected="selected"</c:if> value="1005">변경자ID<option>
                        </select>
                    </div>
                    <div class="form-group">
    ...
    <div class="block">
        <!-- 리스트 -->
        <table class="table table-bordered table-striped table-hover op-table-list" summary="사용자 로그 목록 으로 순번,ID,성명,변경일시,변경자(변경자ID),변경(수정)내용,변경(수정)사유 정보를 제공합니다.">
