...
<script type="text/javascript">
	...
	var opCloseWin = function() {
		...
		if (checkUpdateCnt > 0) parent.opReload();
...
<body>
	...
	<form name="dataForm" id="dataForm" method="post" action="ND_updateEntrprsUser.do" class="form-horizontal">
	...
	<div class="panel panel-default">
		...
		<div class="panel-body">
			<div class="form-group">
						...
						<div class="col-xs-9">
							<div class="row">
								<div class="col-xs-3">
									...
									<input type="text" name="crno" id="crno" value="${dataVo.crno}" maxlength="13" class="form-control" title="법인등록번호 앞자리를 입력해주세요" />
								</div>
								<%-- <div class="col-xs-3">
									<label for="jurirno2" class="sr-only">법인등록번호 뒷자리</label>
									<input type="text" name="jurirno2" id="jurirno2" value="${dataVo.jurirno2}" maxlength="7" class="form-control" title="법인등록번호 뒷자리를 입력해주세요" />
								</div> --%>
							</div>
							<div class="row">
								<div class="col-xs-12">
									<valid:msg name="crno" />
									<%-- <valid:msg name="jurirno2" /> --%>
								</div>
							</div>
						</div>
					</div>
				...
				<div class="form-group">
					<label class="control-label col-xs-3">가입일시</label>
					<div class="col-xs-9">
						<div class="row">
							<div class="col-xs-6">
				...
				<div class="form-group">
					<label class="control-label col-xs-3">최근접속일시</label>
					<div class="col-xs-9">
						<div class="row">
				...
				<c:if test="${entrprsUserIemEstbs.moblphonNoUseAt ne 1002 }">
					<div class="form-group">
						...
						<div class="col-xs-9">
							<div class="row">
								<div class="col-xs-4">
									<label for="rgnTelno" class="sr-only">휴대전화번호 앞자리</label>
									<op:cdId type="select" hghrkCdId="mobileTy" cdId="mobileTy" id="mblRgnTelno" values="${dataVo.mblRgnTelno}" />
								</div>
								<div class="col-xs-4">
									<label for="telofcTelno" class="sr-only">휴대전화번호 중간자리</label>
								...
								<div class="col-xs-4">
									<label for="indivTelno" class="sr-only">휴대전화번호 뒷자리</label>
		...
		<div class="block clearfix">
			<div class="col-xs-12 btn-group">
				<div class="pull-right">
					<button type="button" onclick="opUpdateEntrprsUser()" class="btn btn-success">수정</button>
				</div>
			</div>
		</div>
		<!-- //버튼 -->
