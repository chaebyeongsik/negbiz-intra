    ...
    <div class="panel panel-primary">
        <div class="panel-heading">
            <h6 class="panel-title">
                <i class="icon-libreoffice"></i> 게시판 ${tmpltTypeCd} 등록
            </h6>
        </div>
        <div class="panel-body">
            <form name="dataForm" id="dataForm" method="post" enctype="multipart/form-data" action="ND_insertBbsTmplat.do" class="form-horizontal">
                <input type="hidden" name="tmpltTypeCd" id="tmpltTypeCd" value="${paramMap.q_tmpltTypeCd}" />
                <%-- 페이징 관련 파라미터 생성 --%>
                    ...
                    <div class="panel-body">
                        <div class="col-sm-9">
                            <div class="form-group">
                                <label for="tmpltId" class="control-label col-sm-3">
                                    <span class="mandatory">*</span> 템플릿아이디
                                </label>
                                <div class="col-sm-9">
                                    <div class="row">
                                        <div class="col-sm-5">
                                            <input type="text" name="tmpltId" id="tmpltId" maxlength="15" class="form-control" placeholder="템플릿아이디" />
                                        </div>
                                        <div class="col-sm-5" id="dplctChckId">
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <valid:msg name="tmpltId" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="tmpltNm" class="control-label col-sm-3">
                                    <span class="mandatory">*</span> 템플릿이름
                                </label>
                                <div class="col-sm-9">
                                    <div class="row">
                                        <div class="col-sm-10">
                                            <input type="text" name="tmpltNm" id="tmpltNm" value="" maxlength="100" class="form-control" placeholder="템플릿이름" />
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-sm-12">
                            ...
                            <div class="form-group">
                                <label for="tmpltCn" class="control-label col-sm-3">
                                    <span class="mandatory">*</span> 템플릿소스
                                </label>
                                <div class="col-sm-9">
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <textarea name="tmpltCn" id="tmpltCn" rows="15" cols="80" class="form-control" placeholder="HTML코딩된 소스를 입력"></textarea>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-sm-12">
                            ...
                            <div class="form-group">
                                <label for="tmplatScrsht" class="control-label col-sm-3"> 템플릿미리보기첨부</label>
                                <div class="col-sm-9">
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <op:fileUpload view="basic" name="tmplatScrsht" size="300K" maxSize="300K" count="1" exts="jpg,jpeg,gif,png" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-sm-3">
                            <div class="panel panel-info">
                                ...
                                <div class="panel-body" style="max-height:550px;overflow-y:scroll;">
                                    ...
                                    <c:choose>
                                        <c:when test="${paramMap.q_tmpltTypeCd eq 'L'}">
                                            버튼 <code>&lt;bbs:button type="list" /&gt;</code>
                                        </c:when>
                                        <c:when test="${paramMap.q_tmpltTypeCd eq 'V'}">
                                            버튼 <code>&lt;bbs:button type="view" obj="&#36;{dataVo}" /&gt;</code>
                                        </c:when>
                                        <c:when test="${paramMap.q_tmpltTypeCd eq 'F'}">
                                            버튼 <code>&lt;bbs:button type="form" obj="&#36;{dataVo}" /&gt;</code>
                                        </c:when>
                                    </c:choose>
