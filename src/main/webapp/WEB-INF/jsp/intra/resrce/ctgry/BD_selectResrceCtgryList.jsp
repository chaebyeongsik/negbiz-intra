...
<script type="text/javascript">
    ...
    var contPadId = "ResrceCtgry_VIEW";
    var Optree;
    ...
    var options = {
        ...
        // view url
        VIEW_URL : "INC_updateResrceCtgryForm.do",
        // node move시 호출될 url
    ...
    <div class="row">
            ...
            <div class="row">
                <div class="col-sm-12 btn-group">
                    <div class="pull-right">
                        <a href="PD_selectResrceCtgryList.do" class="btn btn-info" id="addModal">카테고리추가</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-sm-9">
            <div class="panel panel-primary">
                ...
                <div id="ResrceCtgry_VIEW" class="panel-body"></div>
            </div>
        </div>
    </div>
