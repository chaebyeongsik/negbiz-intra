...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        // radio 버튼 선택 값 설정
        opChecked("clsfUseYn", "N");
        opChecked("ntcUseYn", "N");
        opChecked("nfeedUseYn", "N");
        opChecked("pstgUseYn", "N");
        opChecked("prvcClctAgreYn", "N");
        opChecked("useYn", "Y");
...
<body>
    <div class="panel panel-primary">
        ...
        <div class="panel-body">
            <form name="dataForm" id="dataForm" method="post" action="ND_insertBbsMngr.do" class="form-horizontal">
                <%-- 페이징 관련 파라미터 생성 --%>
                    ...
                    <div class="panel-body">
                        <div class="form-group">
                            ...
                            <div class="col-xs-10">
                                <div class="row">
                                    <div class="col-xs-6">
                                        <input type="text" name="bbsNm" id="bbsNm" value="" maxlength="300" class="form-control" />
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-xs-12">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-xs-10">
                                <div class="row">
                                    <div class="col-xs-12">
                                        <textarea name="bbsExpln" id="bbsExpln" rows="5" cols="80" class="form-control"></textarea>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-xs-12">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="row">
                                            <div class="col-md-3" id="divDomn0">
                                                <label for="siteSn0" class="checkbox-inline checkbox-primary">
                                                    <input type="checkbox" name="siteSns" id="siteSn0" value="0" class="styled" />
                                                    관리자
                                                </label>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-8">
                                                        <select name="lstTmpltNm" id="lstTmpltNm0" class="form-control" disabled="disabled">
                                                            <option value="">--</option>
                                                            <c:forEach items="${listTmplats}" var="list">
                                                                <option value="${list.tmpltId}">${list.tmpltNm}</option>
                                                            </c:forEach>
                                                        </select>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-md-3">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-8">
                                                        <select name="pstTmpltNm" id="pstTmpltNm0" class="form-control" disabled="disabled">
                                                            <option value="">--</option>
                                                            <c:forEach items="${redngTmplats}" var="view">
                                                                <option value="${view.tmpltId}">${view.tmpltNm}</option>
                                                            </c:forEach>
                                                        </select>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-md-3">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-8">
                                                        <select name="inptTmpltNm" id="inptTmpltNm0" class="form-control" disabled="disabled">
                                                            <option value="">--</option>
                                                            <c:forEach items="${formTmplats}" var="form">
                                                                <option value="${form.tmpltId}">${form.tmpltNm}</option>
                                                            </c:forEach>
                                                        </select>
                                                    </div>
                                                </div>
                                        ...
                                        <c:forEach items="${domainList}" var="domnList" varStatus="status">
                                            <div class="row">
                                                <div class="col-md-3" id="divDomn${status.index}">
                                                    <label for="siteSn${status.count}" class="checkbox-inline checkbox-primary">
                                                        <input type="checkbox" name="siteSns" id="siteSn${status.count}" value="${domnList.siteSn}" class="styled" />
                                                        ${domnList.siteExpln}
                                                    </label>
                                                </div>
                                                <div class="col-md-3">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-8">
                                                            <select name="lstTmpltNm" id="lstTmpltNm${domnList.siteSn}" class="form-control" disabled="disabled">
                                                                <option value="">--</option>
                                                                <c:forEach items="${listTmplats}" var="list">
                                                                    <option value="${domnList.siteSn}_${list.tmpltId}">${list.tmpltNm}</option>
                                                                </c:forEach>
                                                            </select>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="col-md-3">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-8">
                                                            <select name="pstTmpltNm" id="pstTmpltNm${domnList.siteSn}" class="form-control" disabled="disabled">
                                                                <option value="">--</option>
                                                                <c:forEach items="${redngTmplats}" var="view">
                                                                    <option value="${domnList.siteSn}_${view.tmpltId}">${view.tmpltNm}</option>
                                                                </c:forEach>
                                                            </select>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="col-md-3">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-8">
                                                            <select name="inptTmpltNm" id="inptTmpltNm${domnList.siteSn}" class="form-control" disabled="disabled">
                                                                <option value="">--</option>
                                                                <c:forEach items="${formTmplats}" var="form">
                                                                    <option value="${domnList.siteSn}_${form.tmpltId}">${form.tmpltNm}</option>
                                                                </c:forEach>
                                                            </select>
                                                        </div>
                                                    </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-xs-10">
                                <label for="ntcUseYnY" class="radio-inline radio-primary">
                                    <input type="radio" name="ntcUseYn" id="ntcUseYnY" value="Y" class="styled" />
                                    예
                                </label>
                                <label for="ntcUseYnN" class="radio-inline radio-primary">
                                    <input type="radio" name="ntcUseYn" id="ntcUseYnN" value="N" checked="checked" class="styled" />
                                    아니오
                                </label>
                                <div class="row">
                                    <div class="col-xs-12">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-xs-10">
                                <label for="nfeedUseYnY" class="radio-inline radio-primary">
                                    <input type="radio" name="nfeedUseYn" id="nfeedUseYnY" value="Y" class="styled" />
                                    예
                                </label>
                                <label for="nfeedUseYnN" class="radio-inline radio-primary">
                                    <input type="radio" name="nfeedUseYn" id="nfeedUseYnN" value="N" checked="checked" class="styled" />
                                    아니오
                                </label>
                                <div class="row">
                                    <div class="col-xs-12">
                                ...
                                <div class="row">
                                    <div class="col-md-8">
                                        ...
                                        <label for="clsfUseYnN" class="radio-inline radio-primary">
                                            <input type="radio" name="clsfUseYn" id="clsfUseYnN" value="N" checked="checked" class="styled" />
                                            아니오
                                        </label>
                                    </div>
                                </div>
                        ...
                        <div class="form-group" id="clConfig" style="display: none;">
                            ...
                            <div id="clGroupDiv" class="col-md-10">
                                ...
                                <div class="row well">
                                    <div class="row">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" name="lwrkClsfNms" value="" class="form-control tags" placeholder="하위분류명" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-xs-10">
                                <label for="pstgUseYnY" class="radio-inline radio-primary">
                                    <input type="radio" name="pstgUseYn" id="pstgUseYnY" value="Y" class="styled" />
                                    예
                                </label>
                                <label for="pstgUseYnN" class="radio-inline radio-primary">
                                    <input type="radio" name="pstgUseYn" id="pstgUseYnN" value="N" checked="checked" class="styled" />
                                    아니오
                                </label>
                                <div class="row">
                                    <div class="col-xs-12">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-4">
                                                <label for="prvcClctAgreYnN" class="radio-inline radio-primary">
                                                    <input type="radio" name="prvcClctAgreYn" id="prvcClctAgreYnN" value="N" checked="checked" class="styled" /> 미수집
                                                </label>
                                                <label for="prvcClctAgreYnN" class="radio-inline radio-primary">
                                                    <input type="radio" name="prvcClctAgreYn" id="prvcClctAgreYnY" value="Y" class="styled" /> 수집
                                                </label>
                                                <div class="row">
                                                    <div class="col-sm-12">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-sm-6">
                                                                <label for="prvcDelSeCdD" class="radio-inline radio-primary">
                                                                    <input type="radio" name="prvcDelSeCd" id="prvcDelSeCdD" value="D" class="styled" /> 날짜입력
                                                                </label>
                                                            </div>
                                                            <div class="col-sm-6">
                                                                <input type="text" class="datepicker form-control" name="prvcDelYmd" id="prvcDelYmd" value="" maxlength="10" disabled="disabled" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-sm-6">
                                                                <label for="prvcDelSeCdY" class="radio-inline radio-primary">
                                                                    <input type="radio" name="prvcDelSeCd" id="prvcDelSeCdY" value="Y" class="styled" /> 기간선택
                                                                </label>
                                                            </div>
                                                            <div class="col-sm-6">
                                                                <select id="prvcStrgDayCnt" name="prvcStrgDayCnt" class="select" disabled="disabled">
                                                                        <option value="">- 선택 -</option>
                                                                    <c:forEach var="trm" begin="1" end="2" step="1">
                                                                        <option value="${trm}">${trm}년</option>
                                                                    </c:forEach>
                                                                </select>
                                                            </div>
                                                        </div>
