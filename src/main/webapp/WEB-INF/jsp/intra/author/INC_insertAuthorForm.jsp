            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-10">
                        <div class="row">
                            <div class="col-md-6">
                                <input type="text" name="authrtCdId" id="authrtCdId" placeholder="권한코드를 입력해주세요" value="" class="form-control" />
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-10">
                        <div class="row">
                            <div class="col-md-12">
                                <textarea name="authrtExpln" id="authrtExpln" placeholder="권한설명을 입력해주세요" rows="3" class="form-control"></textarea>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-8">
