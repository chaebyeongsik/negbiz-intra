...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        // 코드선택 중복 체크
        $("#cdChcId").keyup(function(event) {
            var len = $(this).val().length;
            if(len >= 2) {
                $.ajax({
                    url : "ND_selectDplctChckCodeChoice.do",
                    type : "GET",
                    dataType : "json",
                    data : {
                        cdChcId : $(this).val(),
...
<body>
    ...
    <form name="dataForm" id="dataForm" method="post" action="ND_insertCodeChoice.do" class="form-horizontal">
        <%-- 페이징 관련 파라미터 생성 --%>
        ...
        <div class="panel panel-default">
            <div class="panel-body">
                ...
                <div class="form-group">
                    <label for="cdChcId" class="control-label col-sm-2">
                        <span class="mandatory">*</span> 코드선택자
                    </label>
                    <div class="col-sm-10">
                        <div class="row">
                            <div class="col-sm-4">
                                <input type="text" name="cdChcId" id="cdChcId" value="" class="form-control" placeholder="코드선택" />
                            </div>
                            <div class="col-sm-8" id="duplicateText"></div>
                        </div>
                        <div class="row">
                            <div class="col-sm-12">
                                <valid:msg name="cdChcId" />
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="panel-icons-group">
                                    <a href="#" class="btn btn-link btn-icon" onclick="reload(); return false;">
                                        <i class="icon-spinner7"></i>
                                    </a>
                                    <a href="#" class="btn btn-link btn-icon" onclick="expandAll(); return false;">
                                        <i class="icon-plus-circle"></i>
                                    </a>
                                    <a href="#" class="btn btn-link btn-icon" onclick="collapseAll(); return false;">
