...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        opChecked("httpsYn", "${dataVo.httpsYn}", "N");
        opChecked("actlStngYn", "${dataVo.actlStngYn}", "N");
    });
...
<body>
    ...
    <form name="dataForm" id="dataForm" method="post" action="ND_updateDomn.do" class="form-horizontal">
        ...
        <div class="panel panel-default">
            <div class="panel-body">
                ...
                <div class="form-group">
                    <label for="siteSn" class="control-label col-md-2"> 도메인코드 </label>
                    <div class="col-md-10">
                        <div class="row">
                            <div class="col-md-6">
                                <p class="form-control-static">${dataVo.siteSn}</p>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-10">
                        <div class="row">
                            <div class="col-md-5">
                                <input type="text" name="siteExpln" id="siteExpln" value="${dataVo.siteExpln}" class="form-control" placeholder="홈페이지 한글이름" />
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-10">
                        <div class="row">
                            <div class="col-md-4">
                                <input type="text" name="siteNm" id="siteNm" value="${dataVo.siteNm}" class="form-control" placeholder="www.example.com" />
                            </div>
                            <div class="col-md-3">
                                <div class="row">
                                    ...
                                    <div class="col-md-7">
                                        <input type="text" name="portSn" id="portSn" value="${dataVo.portSn}" class="form-control" placeholder="80" />
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-5">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text" name="sitePathNm" id="sitePathNm" value="${dataVo.sitePathNm}" class="form-control" placeholder="/content" />
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4">
                        <div class="row">
                            <div class="col-md-4">
                                <input type="text" name="scrtyPortSn" id="scrtyPortSn" value="${dataVo.scrtyPortSn}" class="form-control" placeholder="443" />
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12">
                ...
                <div class="form-group">
                    <label for="actlStngYnY" class="control-label col-md-2">
                ...
                <div class="form-group">
                    <label for="siteNm" class="control-label col-md-2"> 서버 그룹 </label>
                    <div class="col-md-10">
                        ...
                        <c:forEach var="domainGroupVo" items="${dataVo.domnGroupList}">
                            <div class="row">
                                <div class="col-md-5">
                                    <div class="row">
                                        ...
                                        <div class="col-md-8">
                                            <input type="text" name="srvrIpAddr" id="srvrIpAddr" value="${domainGroupVo.srvrIpAddr}" class="form-control" placeholder="www.example.com" />
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="row">
                                        ...
                                        <div class="col-md-7">
                                            <input type="text" name="groupPortSn" id="groupPortSn" value="${domainGroupVo.groupPortSn}" class="form-control" placeholder="80" />
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-2">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-10">
                        <div class="row">
                            <div class="col-md-5">
                                <op:cdId id="langCdId" type="select" hghrkCdId="localeCode" cdId="localeCode" values="${dataVo.langCdId}" />
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12">
                            ...
                            <div class="col-md-12">
                                <div class="row">
                                    ...
                                    <div class="col-md-9">
                                        ...
                                        <div class="col-md-5" id="toggleButton">
                                            <c:if test="${not empty dataVo.picId}">
        ...
        <div class="row">
            <div class="col-md-12 btn-group">
                <div class="pull-right">
                    ...
                    <button type="button" class="btn btn-danger" onclick="opDelete('ND_deleteDomn.do');">삭제</button>
                </div>
            </div>
        </div>
        <!-- //버튼 -->
