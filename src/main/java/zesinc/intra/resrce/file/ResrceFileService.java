 ...
 * @see
 */
public interface ResrceFileService {
     ...
     * @throws Exception
     */
    Integer deleteResrceFile(ResrceFileVO resrceFileVo) throws Exception;
     ...
     * @throws Exception
     */
    Integer deleteResrceFileList(ResrceFileVO resrceFileVo) throws Exception;
