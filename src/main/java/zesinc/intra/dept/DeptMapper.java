...
public interface DeptMapper {
     ...
     * @return
     */
    Integer updateDeptSortOrder(DeptVO deptVo);
     ...
     * @return
     */
    List<DeptVO> selectSamensslDpList(DeptVO deptVo);
     ...
     * @return
     */
    List<DeptVO> selectChldrnDeptList(DeptVO deptVo);
     ...
     * @return
     */
    Integer deleteLowerPartDept(DeptVO deptVo);
