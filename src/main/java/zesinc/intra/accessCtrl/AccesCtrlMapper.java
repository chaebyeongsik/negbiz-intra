 ...
 * @see
 */
@Mapper("opAccesCtrlDao")
public interface AccesCtrlMapper {
     ...
     * @return
     */
    Integer selectAccesCtrlListCount(AccesCtrlVO accesCtrlVo);
     ...
     * @return
     */
    Integer deleteAccesCtrl(AccesCtrlVO accesCtrlVo);
